...
public abstract class Parser {
  ...
  public static String[] parseComplexSingleLineCommand(String complexCommand) {
    String parsedCommands = complexCommand.replaceAll(" +", " ")
        ...
        .replaceAll("([^- 0-9])(?=[0-9])", "$1 ") // replaces negative numbers
        .trim(); // removes spaces at the front and end of the parsed command
    return parseCommandForSpaces(parsedCommands);
  }
}
